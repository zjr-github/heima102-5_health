...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "Uie8UP-GorEUcL3DuoOAwgfOBTX3yXeeeLy7Fo0r";
    private static final String SECRETKEY = "AnM0Lsozte1btxCaPJ92tRijmIfc5Snat__07HBA";
